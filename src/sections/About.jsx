  ...
  return (
    <section className="my-20 c-space" id="about">
      <div className="grid h-full grid-cols-1 gap-5 xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2">
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            <img src="assets/dev.png" alt="grid-2" className="w-full sm:h-[276px] h-fit object-contain" />
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="font-medium text-white lg:text-2xl md:text-xl text-gray_gradient">muhammadfaizanali18@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
